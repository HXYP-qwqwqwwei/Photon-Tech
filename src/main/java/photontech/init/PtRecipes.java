...
public class PtRecipes {
    public static final DeferredRegister<IRecipeSerializer<?>> RECIPES = DeferredRegister.create(ForgeRegistries.RECIPE_SERIALIZERS, Utils.MOD_ID);
...
//    public static final RegistryObject<IRecipeSerializer<CrucibleMeltingRecipe>> MELTING_RECIPE = RECIPES.register("melting", CrucibleMeltingRecipeSerializer::new);
    ...
    public static class Types {
        public static final IRecipeType<PtConditionalRecipe> CONDITIONAL_TYPE = IRecipeType.register(Utils.MOD_ID + "conditional");
