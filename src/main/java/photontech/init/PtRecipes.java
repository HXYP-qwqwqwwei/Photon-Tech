...
//    public static final RegistryObject<IRecipeSerializer<CrucibleMeltingRecipe>> MELTING_RECIPE = RECIPES.register("melting", CrucibleMeltingRecipeSerializer::new);
    public static final RegistryObject<IRecipeSerializer<ConditionalRecipe>> CONDITIONAL_RECIPE = RECIPES.register("conditional", PtConditionalRecipeSerializer::new);

    public static class Types {
        public static final IRecipeType<ConditionalRecipe> CONDITIONAL_TYPE = IRecipeType.register(PhotonTech.ID + "conditional");
