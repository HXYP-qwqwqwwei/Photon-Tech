...
public interface HeatReservoir extends SaveLoadable {
    ...
    static void heatExchange(HeatReservoir h1, HeatReservoir h2, float rate) {
    ...
    static void heatExchange(HeatReservoir h1, HeatReservoir h2) {
        heatExchange(h1, h2, -1F);
    }


    static void heatTransfer(HeatReservoir from, HeatReservoir to, float rate) {
